     ...
     <div className='h-screen  flex flex-col items-center  '>
      <div className='h-full flex flex-col border border-2 w-screen md:w-96'>
        ...
        <div className='h-full p-4 bg-[#F7F8F9] '>
          ...
          <p className='mt-3 mb-3 text-gray-500'>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Impedit quidem iure cum similique, debitis accusamus, a, veritatis tenetur atque quasi quas repellendus blanditiis dolore! Quasi, et. Corporis consequatur optio ea.</p>
